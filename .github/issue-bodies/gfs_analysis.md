...
## Data Sources & Access
- **Forecast:** GFS analysis products from the same 00/06/12/18Z cycles as other GFS tasks (NOAA open data / NOMADS); extract 2m temperature and 10m wind (or u/v) at valid times corresponding to each lead time's verification, or document if only analysis-at-init is used.
